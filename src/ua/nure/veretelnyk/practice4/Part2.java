...
public class Part2 {
    ...
    private static void init() throws IOException {
        BufferedWriter out = new BufferedWriter(
                new OutputStreamWriter(new FileOutputStream("part2.txt"), "UTF-8"));
    ...
    private static void sort() throws IOException {
        BufferedReader in = new BufferedReader(
                new InputStreamReader(new FileInputStream("part2.txt"), "UTF-8"));
    ...
    private static void print() throws IOException {
        ...
        in = new BufferedReader(
                new InputStreamReader(new FileInputStream("part2_sorted.txt"), "UTF-8"));
